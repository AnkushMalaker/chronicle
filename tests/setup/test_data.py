...
SAMPLE_MEMORIES = [
    {"text": "User prefers AI discussions in the morning", "importance": 0.8},
    {"text": "User is interested in machine learning applications", "importance": 0.7},
]

# Construct path relative to the tests directory (works from any working directory)
_tests_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
TEST_AUDIO_FILE = os.path.join(
    _tests_dir, "test_assets", "DIY_Experts_Glass_Blowing_16khz_mono_1min.wav"
)
