...
from backend.controllers.conversation_controller import get_conversations
...
from backend.services.memory.scope import MemoryScope, MemoryScopeError
from backend.services.memory.vault_scaffold import confined_vault_path
from backend.services.memory_space_context import (
    available_screen_sources,
    frame_key,
    request_contact_sheet,
)
from backend.services.memory_spaces import MemorySpaceConflict, memory_space_service
from backend.services.vault_sync import VaultSyncUnavailable, vault_sync_broker
