...
def _queue_dispatch(notification_id: str) -> str | None:
    ...
    from backend.controllers.queue_controller import enqueue_notification_dispatch
...
async def queue_receipt_check() -> dict[str, int | str | None]:
    ...
    from backend.controllers.queue_controller import enqueue_notification_receipts
