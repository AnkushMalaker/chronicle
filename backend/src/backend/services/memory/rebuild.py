...
from backend.services.data_archive import clear_vault_contents
...
def _enqueue_timeline_rebuild(
    ...
    from backend.workers.timeline_jobs import rebuild_timeline_day_job
...
def _active_rebuild_jobs(conversation_ids: set[str], user_ids: set[str]) -> list[str]:
    ...
    for job_id in job_ids:
        ...
        is_timeline_day_job = (
            job.func_name == "backend.workers.timeline_jobs.rebuild_timeline_day_job"
        )
