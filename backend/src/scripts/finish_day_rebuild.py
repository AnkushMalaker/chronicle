...
from backend.controllers.queue_controller import memory_queue
...
from backend.services.memory.vault_scaffold import canonical_vault_scaffold
...
def _enqueue(
    ...
    *,
    ...
    # A partial legacy vault write is never resumed directly. Rebuild the derived day
    # and send its resulting canonical snapshot through the human review proposal.
    entrypoint = "backend.workers.rebuild_timeline_day_job"
