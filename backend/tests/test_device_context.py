...
from backend.routers.modules.device_input_routes import ActivityItem
from backend.services import device_context
...
def _locator(track_id: str = "display-1") -> EvidenceLocator:
