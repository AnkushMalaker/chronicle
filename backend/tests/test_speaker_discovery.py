from backend.controllers.guided_enrollment_controller import _information_score
from backend.workers.speaker_discovery_jobs import (
    _active_segments,
...
def test_discovery_job_is_rq_importable():
    assert discover_speaker_candidates_job.__module__ == (
        "backend.workers.speaker_discovery_jobs"
    )
