...
from backend.models.manual_memory import ManualMemory, ManualMemoryAttachment
from backend.services.manual_memories.image import _body, write_memory_note
from backend.services.memory.vault_media import promote_image_bytes
from backend.services.timeline.evidence import _manual_memory_item
...
def test_initial_vault_note_is_searchable_before_enrichment(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "backend.services.manual_memories.image.vault_note_lock",
