...
from advanced_omi_backend.model_registry import AppModels, LLMOperationConfig, ModelDef
from advanced_omi_backend.services.vision.structured_vision import (
    VisionUnavailable,
...
def test_vision_route_identity_exposes_effective_model(monkeypatch):
    monkeypatch.setattr(
        "advanced_omi_backend.services.vision.structured_vision.get_models_registry",
        _registry,
    )
...
async def test_model_vision_uses_named_operation_and_data_url(monkeypatch):
    ...
    monkeypatch.setattr(
        "advanced_omi_backend.services.vision.structured_vision.async_chat_with_tools",
        fake_chat,
    )
