...
Two collections. All paths under `backends/advanced/src/advanced_omi_backend/`.
...
| Immich config | `.env.template`, wizard (`backends/advanced/init.py`) | `IMMICH_URL`, `IMMICH_API_KEY`. |
