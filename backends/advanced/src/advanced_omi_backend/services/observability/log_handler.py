...
it as a :class:`~advanced_omi_backend.models.system_event.SystemEvent` (via the
...
_SKIP_PREFIXES = (
    "observability",
    "advanced_omi_backend.services.observability",
    "sse_publisher",
    "advanced_omi_backend.services.sse_publisher",
    "redis",
    "urllib3",
    "httpcore",
)
