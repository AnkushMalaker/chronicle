...
def is_secret_field(
    field_name: str, additional_keywords: Optional[List[str]] = None
) -> bool:
    """
...
def mask_dict(
    ...
    for key, value in data.items():
        ...
        is_secret = key.lower() in secret_fields_lower or is_secret_field(
...
def create_masked_repr(
    obj: Any, secret_attrs: Set[str], mask: str = SECRET_MASK
) -> str:
    """
